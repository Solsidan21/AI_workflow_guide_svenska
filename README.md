...
|----|---------|-------------|
| 00 | [Grundbegrepp](docs/00-grundbegrepp.md) | De ~10 begrepp som öppnar dörren till nästa nivå |
...
| Nr | Kapitel | Beskrivning |
|----|---------|-------------|
| 04 | [Exempel: Studier](docs/04-exempel-studier.md) | Hela kursen i fickan *(kommer snart)* |
| 05 | [Exempel: Private Equity](docs/05-exempel-private-equity.md) | Norvik Capital — hela firmans AI-system i praktiken |
| 06 | [Exempel: Marknadsförare](docs/06-exempel-marknadsforing.md) | AI i det dagliga arbetet *(kommer snart)* |
| 07 | [Exempel: Konsult](docs/07-exempel-konsult.md) | Från analys till leverans *(kommer snart)* |
...
- **Ny till allt bortom chatten?** Börja med [kapitel 00](docs/00-grundbegrepp.md) — det tar några minuter och ger dig ordförrådet.
...
- **Vill se ett konkret exempel?** [Kapitel 05](docs/05-exempel-private-equity.md) visar hur en hel PE-firma sätter upp sitt AI-system.
