...
Varje AI-modell har ett **kontextfönster**: en maximal mängd information den kan ha "i huvudet" samtidigt. Det mäts i tokens (du lärde dig om **tokens** (AI:ns enhet för textlängd, ungefär tre fjärdedelar av ett ord, se [ordlistan](ordlista.md))).
...
Inte all information kostar lika mycket kontext. En 50-sidig PDF förbrukar enormt med tokens varje gång den läses, även om du bara behöver tre rader. Samma information i **Markdown** (ett enkelt textformat med rubriker, listor och tabeller, se [ordlistan](ordlista.md)) kostar en bråkdel. Se [PDF-problemet](#pdf-problemet-den-vanligaste-flaskhalsen) nedan och [kapitel 03](03-mappstruktur-och-arbetssatt.md) för hur du löser det.
